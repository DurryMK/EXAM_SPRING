...
public class PhoneCode {
     ...
     * @Param msg 要发送的信息
     */
    public static String sendSMS(String mobile, String mb, String msg, Map keyMap) {
        if(StaticPeram.SEDNSUCCESS.equals("0")){
            return StaticPeram.SEDNSUCCESS;
        }
        /**
         * 进行正则关系校验
         */
